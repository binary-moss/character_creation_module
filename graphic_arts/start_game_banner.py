...
def animation(screen):
    ...
    scenes.append(Scene(effects, 30)) # scenes.append(Scene(effects, -1))

    screen.play(scenes, stop_on_resize=True, repeat=False) # screen.play(scenes, stop_on_resize=True)
